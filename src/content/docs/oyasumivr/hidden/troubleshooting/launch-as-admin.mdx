...
### I didn't launch OyasumiVR as administrator

If you're launching OyasumiVR through Steam or another game/app launcher, make sure that is not running with administrator permissions either.

When Steam (or your launcher) is running with administrative permissions and then launches a game or app like OyasumiVR, that app will inherit the administrative permissions.
...
You should only have to do this once. You can now close the command prompt.
If everything went correctly, from now on you should be able to run OyasumiVR with administrative privileges.

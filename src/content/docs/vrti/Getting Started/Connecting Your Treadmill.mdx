...
You can change your active driver in the settings menu.

## Settings

The circular settings button in the top left corner will open the settings menu.
...
In the settings menu, you can switch between various drivers.

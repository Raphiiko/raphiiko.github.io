...
VRTI will automatically connect to your treadmill when it finds it. Just turn your treadmill on, make sure your PC's Bluetooth is enabled, and wait a few seconds!

:::tip[Did you know?]
To read about controlling your Treadmill from within VRChat, check out [OSC Control](/vrti/getting-started/osc-control)!
:::
...
The circular settings button in the top left corner will open the settings menu, where you can adjust various settings for VRTI.
